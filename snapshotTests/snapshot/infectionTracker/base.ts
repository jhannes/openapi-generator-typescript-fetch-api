...
export class BaseAPI {
    protected query(queryParams: any): string {
        return queryParams && Object.keys(queryParams).length ? ("?" + Object.keys(queryParams)
    ...
    protected async handleResponse(response: Response): Promise<any> {
        ...
        const body: any = contentType && contentType.startsWith("application/json") && await response.json();
